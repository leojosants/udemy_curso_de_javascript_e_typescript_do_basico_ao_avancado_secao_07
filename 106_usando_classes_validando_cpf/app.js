(() => {
    ...
    class ValidadeCPF {
        ...
        generateNewCPF() {
            ...
            const digit_1 = ValidadeCPF.generateDigit(cpf_without_digits);
            const digit_2 = ValidadeCPF.generateDigit(cpf_without_digits + digit_1);
    ...
    const displayInfo = (validade_cpf, cpf) => {
        let message = '';
        validade_cpf.valid() ? message = 'valido' : message = 'invalido';
        console.log(`\nCPF ${cpf} é ${message}`);
    };
